  ...
  void Start()
  {
        ...
        public IEnumerator FormattedSolution()
        {
            ...
            var solutionExpected = string.Join("\r\n", new[]
            {
                ...
                @"# Visual Studio 2010",
                @"Project(""{{{0}}}"") = ""AsmdefResponse"", ""AsmdefResponse.csproj"", ""{{{1}}}""",
                @"EndProject",
                @"Project(""{{{0}}}"") = ""Assembly-CSharp"", ""Assembly-CSharp.csproj"", ""{{{2}}}""",
                @"EndProject",
                @"Project(""{{{0}}}"") = ""Unity.VSCode.Editor"", ""Unity.VSCode.Editor.csproj"", ""{{{3}}}""",
                @"EndProject",
                @"Project(""{{{0}}}"") = ""Assembly-CSharp-Editor"", ""Assembly-CSharp-Editor.csproj"", ""{{{4}}}""",
                @"EndProject",
                @"Global",
